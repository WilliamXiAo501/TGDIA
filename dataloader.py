    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            if self.args.do_kb_crop is True:
                ...
                depth_gt = depth_gt.crop((left_margin, top_margin, left_margin + 704, top_margin + 352))
                image = image.crop((left_margin, top_margin, left_margin + 704, top_margin + 352))
            ...
            if self.args.do_kb_crop is True:
                ...
                top_margin = int(height - 352)
                left_margin = int((width - 704) / 2)
                image = image[top_margin:top_margin + 352, left_margin:left_margin + 704, :]
                if self.mode == 'online_eval' and has_valid_depth:
                    depth_gt = depth_gt[top_margin:top_margin + 352, left_margin:left_margin + 704, :]
